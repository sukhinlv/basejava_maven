...
public final class TestResumesGenerator {
    public static Resume createTestResumeWithAllFields(String uuid, String fullName) {
    ...
    public static Resume createTestResumeOnlyContacts(String uuid, String fullName) {
        Resume resume = new Resume(uuid, fullName);
    ...
    public static Resume createTestResumeWithAllFieldsMinimal(String uuid, String fullName) {
        Resume resume = new Resume(uuid, fullName);
        ...
        contacts.put(ContactType.HOMEPAGE, "https://vk.com/musinov80");
        resume.setContacts(contacts);
